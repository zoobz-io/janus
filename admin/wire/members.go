...
var memberRoles = []string{"viewer", "editor", "admin", "owner"}
...
// MemberListResponse is the admin API response for a list of members.
type MemberListResponse struct {
	Members []MemberResponse `json:"members" description:"Tenant members"`
	Total   int64            `json:"total" description:"Total member count" example:"7"`
}
