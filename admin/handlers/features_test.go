...
// TestFeatureEndpointsEnforceScope verifies each endpoint denies a caller that
...
func TestFeatureEndpointsEnforceScope(t *testing.T) {
	...
	roccotest.AssertStatus(t, roccotest.ServeRequest(reads, "GET", "/applications/a1/tiers/t1/features", nil), http.StatusForbidden)
	...
	roccotest.AssertStatus(t, roccotest.ServeRequest(writes, "POST", "/applications/a1/tiers/t1/features", nil), http.StatusForbidden)
	roccotest.AssertStatus(t, roccotest.ServeRequest(writes, "DELETE", "/applications/a1/tiers/t1/features/s1", nil), http.StatusForbidden)
}
